...
;var E={},F=null;var G="function"===typeof Uint8Array;function H(a){return null!==a&&"object"==typeof a&&!Array.isArray(a)&&!(G&&null!=a&&a instanceof Uint8Array)}
...
function da(a){switch(typeof a){case "number":return isFinite(a)?a:String(a);case "object":if(G&&null!=a&&a instanceof Uint8Array){var b;"object"!=typeof a||a&&Array.isArray(a);void 0===b&&(b=0);if(!F){F={};for(var c="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),d=["+/=","+/","-_=","-_.","-_"],h=0;5>h;h++){var k=c.concat(d[h].split(""));E[h]=k;for(var m=0;m<k.length;m++){var f=k[m];void 0===F[f]&&(F[f]=m)}}}b=E[b];c=Array(Math.floor(a.length/3));d=b[64]||"";for(h=k=0;k<
